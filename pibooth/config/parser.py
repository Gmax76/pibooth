        ...
        odict((
            ("iso",
                (100,
                 ...
                 "ISO", ['camera', '800', '1600', '3200'])),
            ("aperture",
                ('camera',
                 "Set DSLR aperture when supported by the camera mode (or keep the value already set on camera)",
                 "Aperture", ['camera', '5.6', '6.3', '8', '10', '11'])),
            ("shutter_speed",
                ('camera',
                 "Set DSLR shutter speed when supported by the camera mode (or keep the value already set on camera)",
                 "Shutter speed", ['camera', '1/60', '1/100', '1/125'])),
            ("flip",
                (False,
